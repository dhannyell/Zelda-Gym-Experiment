...
if __name__ == '__main__':
    ...
    env_config = {
                ...
                'action_freq': 24, 'init_state': '../skip_intro_with_shield_and_sword.state', 'max_steps': ep_length, 
    ...
    num_cpu = 36 #64 #46  # Also sets the number of episodes per training iteration
