...
if __name__ == '__main__':
    ...
    env_config = {
                ...
                'action_freq': 24, 'init_state': '../zelda_law.gb.state', 'max_steps': ep_length, 
                'print_rewards': True, 'save_video': False, 'fast_video': True, 'session_path': sess_path,
                'gb_path': '../zelda_law.gb', 'debug': False, 'sim_frame_dist': 2_000_000.0, 
    ...
    file_name = 'session_08c06068/zelda_491520_steps' 
    ...
    model.learn(total_timesteps=(ep_length)*num_cpu*2000, callback=CallbackList(callbacks))
